  <!-- Ventana Modal Chat -->
  <div class="modal fade" id="modalChatRep" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
    style="border-radius: 25px">
    <div class="modal-dialog modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header ">
          <i class="fas fa-user-circle fs-1 mx-3"></i>
          <h5 class="modal-title " id="titulomodalChatRep">Chat</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <!-- d-flex justify-content-center align-items-end align-content-end -->
        <div class="modal-body fondoChat" id="contenidomodalChatRep">
          <div class="d-flex flex-column flex-fill">
            <div id="enviaChat" class="align-self-end my-3" style="width: 90%"> Bienvenido al chat de Fast <span
                class="" style="color: gray; float: right;">10:50 pm</span></div>
            ...
            <div id="enviaChat" class="align-self-end my-3" style="width: 90%"> Bienvenido al chat de Fast <span
                class="" style="color: gray; float: right;">10:55 pm</span></div>
            ...
            <div id="enviaChat" class="align-self-end my-3" style="width: 90%"> Bienvenido al chat de Fast <span
                class="" style="color: gray; float: right;">11:01 pm</span></div>
            <div id="recibirChat" class="align-self-start my-3 " style="width: 90%">Lorem ipsum dolor <span class=""
                style="color: gray; float: right;">11:02 pm</span></div>
            <div id="enviaChat" class="align-self-end my-3" style="width: 90%"> Bienvenido al chat de Fast <span
                class="" style="color: gray; float: right;">11:05 pm</span></div>
            <div id="recibirChat" class="align-self-start my-3 " style="width: 90%">Lorem ipsum dolor <span class=""
                style="color: gray; float: right;">11:10 pm</span></div>
            <div id="enviaChat" class="align-self-end my-3" style="width: 90%"> Bienvenido al chat de Fast <span
                class="" style="color: gray; float: right;">11:15 pm</span></div>
            <div id="recibirChat" class="align-self-start my-3 " style="width: 90%">Lorem ipsum dolor <span class=""
                style="color: gray; float: right;">11:30 pm</span></div>
          </div>
        </div>
        <div class="modal-footer" id="piemodalChatRep">
